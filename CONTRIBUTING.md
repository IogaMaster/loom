...
- This repository follows the [Conventional Commits](https://www.conventionalcommits.org/en/v1.0.0/) style.
  ...
  - `feat(renderer): fix longstanding issue`
  - `feat(examples/triangles): speed up init`

  Changes to modules should be scoped like `feat(<module_name>)`,
  If a change doesn't fit any scope, then just don't add a scope.
